...
namespace WebApplication6.Controllers
{
    public class AlunoesController : Controller
    {
        ...
        public AlunoesController(WebApplication6Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Aluno != null ? 
                          ...
                          Problem("Entity set 'WebApplication6Context.Aluno'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("AlunoId,Nome,DataNascimento,Matricula")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlunoId,Nome,DataNascimento,Matricula")] Aluno aluno)
        {
            if (id != aluno.AlunoId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplication6Context.Aluno'  is null.");
            }
            var aluno = await _context.Aluno.FindAsync(id);
            if (aluno != null)
            {
